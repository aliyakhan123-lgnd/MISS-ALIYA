...
console.log("\n" + "=".repeat(60));
console.log("🚀 MISS ALIYA BOT - LAUNCHER SYSTEM 🚀");
...
app.use((req, res, next) => {
    ...
    res.setHeader('X-Powered-By', 'MISS ALIYA BOT');
    next();
});
...
// Configuration
const BOT_SCRIPT = "MISS-ALIYA.js";
...
async function checkForUpdates() {
    const GITHUB_REPO = "MISS ALIYA BOT"; // Change this to your repo
...
// Display banner
console.log("\n" + "⭐".repeat(30));
console.log("    MISS ALIYA BOT - LAUNCHER v2.0");
...
// Start the bot
setTimeout(() => {
    startBot("🚀 Starting MISS ALIYA BOT...");
}, 1000);
